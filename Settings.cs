...
namespace StoryCallouts
{
    internal static class Settings
    {
        ...
        internal static void LoadSettings()
        {
            ...
            Game.LogTrivial($"- Callout 'Prologue' {(callout_Prologue ? "enabled" : "disabled")}");
            callout_FranklinAndLamar = ini.ReadBoolean("Callouts", "FranklinAndLamar", true);
            Game.LogTrivial($"- Callout 'FranklinAndLamar' {(callout_FranklinAndLamar ? "enabled" : "disabled")}");
            callout_TheLongStretch = ini.ReadBoolean("Callouts", "TheLongStretch", true);
            Game.LogTrivial($"- Callout 'TheLongStretch' {(callout_TheLongStretch ? "enabled" : "disabled")}");
            callout_CarbineRifles = ini.ReadBoolean("Callouts", "CarbineRifles", true);
            Game.LogTrivial($"- Callout 'CarbineRifles' {(callout_CarbineRifles ? "enabled" : "disabled")}");
            callout_BugstarsEquipment = ini.ReadBoolean("Callouts", "BugstarsEquipment", true);
            Game.LogTrivial($"- Callout 'BugstarsEquipment' {(callout_BugstarsEquipment ? "enabled" : "disabled")}");
            callout_BZGasGrenades = ini.ReadBoolean("Callouts", "BZGasGrenades", true);
            Game.LogTrivial($"- Callout 'BZGasGrenades' {(callout_BZGasGrenades ? "enabled" : "disabled")}");
            callout_CasingTheJewelStore = ini.ReadBoolean("Callouts", "CasingTheJewelStore", true);
            Game.LogTrivial($"- Callout 'CasingTheJewelStore' {(callout_CasingTheJewelStore ? "enabled" : "disabled")}");
            callout_DeadManWalking = ini.ReadBoolean("Callouts", "DeadManWalking", true);
            Game.LogTrivial($"- Callout 'DeadManWalking' {(callout_DeadManWalking ? "enabled" : "disabled")}");
            callout_HoodSafari = ini.ReadBoolean("Callouts", "HoodSafari", true);
            Game.LogTrivial($"- Callout 'HoodSafari' {(callout_HoodSafari ? "enabled" : "disabled")}");
            callout_TheHotelAssassination = ini.ReadBoolean("Callouts", "TheHotelAssassination", true);
            Game.LogTrivial($"- Callout 'TheHotelAssassination' {(callout_TheHotelAssassination ? "enabled" : "disabled")}");
            callout_GrassRoots_ThePickup = ini.ReadBoolean("Callouts", "GrassRoots_ThePickup", true);
            Game.LogTrivial($"- Callout 'GrassRoots_ThePickup' {(callout_GrassRoots_ThePickup ? "enabled" : "disabled")}");
            callout_BlitzPlay = ini.ReadBoolean("Callouts", "BlitzPlay", true);
            Game.LogTrivial($"- Callout 'BlitzPlay' {(callout_BlitzPlay ? "enabled" : "disabled")}");
            callout_MilitaryHardware = ini.ReadBoolean("Callouts", "MilitaryHardware", true);
            Game.LogTrivial($"- Callout 'MilitaryHardware' {(callout_MilitaryHardware ? "enabled" : "disabled")}");
